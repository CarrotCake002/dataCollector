        ...
        <table id="allLinksTable">
            ...
            <?php
                fputcsv($stream,[
                    ...
                    $openFile->getAllMetaInStr($i), $openFile->getAllMetaSizesInStr($i), $openFile->getMetaIndexInStr($i), $openFile->getMetaFollowInStr($i), 'Meta sponsored', 'Meta ugc', 'Meta noopener',
                    'Nb hreflang', 'Hreflang',
                    'Canonical',
                    'Nb links', 'Links', 'Link <a> tags', 'Link target=blank',
                    'h1', 'h2', 'h3', 'h4', 'h5', 'h6',
